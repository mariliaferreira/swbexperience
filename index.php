			...
			<section class="section-size schedule" id="programacao" data-sr="enter left, hustle 20px">
				...
				<table>
				  ...
				  <tr>
				  	...
				  	<td><img src="img/speech_balloon.png" class="icon" /> Palestra com o Prof. Fernando Luciano, professor PUCPR, palestrante TED: "Viajar para Liderar, isso faz sentido?" </td>
				  </tr>
...
<!--
                <div class="colunas">
                    ...
                    <div class="coluna-1">
                        <label for="cpf" class="label-esp"><b>Nome</b></label><br />
                        <input class="input-inscricao preencher"></input><br />
                        <br />
                    
                        <label for="cpf" class="label-esp"><b>Email</b></label><br />
                        <input class="input-inscricao preencher"></input><br />
                        <br />
                        <label for="cpf"><b>Curso da PUCPR</b></label><br />
                        <input class="input-inscricao preencher"></input><br />
                        <br />
